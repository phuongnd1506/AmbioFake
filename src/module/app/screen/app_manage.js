...
import { getHistoryLogin } from "../utils/API.js";
import { Logout } from "../utils/API.js";
import { handleLogOut, getDataHistorylogin, handleLogOutAll, onRefresh, getDataOnRefresh, getDataUserInfo } from "../util/utils.js";
import { numberPhone } from "../../loading/utils/utils.js";
...
function App_manage({ navigation }) {
    ...
    const onRefreshh = (setHistoryLogins, setIsRefresh) => {
        getDataOnRefresh(setHistoryLogins, setIsRefresh)
    }
